        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              La plateforme leader de vente de liens au Maroc. Achetez et vendez des liens de qualité 
              pour améliorer votre SEO et votre visibilité en ligne.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/sites-web" className="text-gray-300 hover:text-white transition-colors">
                  Sites Web
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center space-x-2 text-gray-300">
                ...
                <span>contact@authority.ma</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Authority.ma. Tous droits réservés.
            </p>
