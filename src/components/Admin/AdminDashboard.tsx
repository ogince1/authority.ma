...
const AdminDashboard: React.FC = () => {
  ...
  React.useEffect(() => {
    trackPageView('/admin', 'Dashboard Admin | Authority.ma');
    loadPlatformStats();
  }, []);
  ...
  const loadPlatformStats = async () => {
    try {
      ...
      setStats({
        ...
        total_link_listings: listingsCount || 0,
        total_purchase_requests: requestsCount || 0,
        total_transactions: transactionsCount || 0,
        total_revenue: totalRevenue,
        total_disputes: disputesCount || 0,
        total_blog_posts: blogCount || 0,
        total_success_stories: storiesCount || 0,
  ...
  const quickActions = [
    ...
    {
      name: 'Gérer les Disputes',
      description: 'Résoudre les disputes en cours',
      icon: AlertTriangle,
      href: '/admin/disputes',
      color: 'bg-red-500'
    },
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Vue d'ensemble de la plateforme Authority.ma
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <div className="text-sm font-medium text-gray-500">Disputes</div>
              <div className="text-2xl font-bold text-gray-900">{stats?.total_disputes}</div>
            </div>
          </div>
        </motion.div>
      </div>
