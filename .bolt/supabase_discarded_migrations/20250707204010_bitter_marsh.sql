/*
  ...
  1. New Tables
    - `chat_messages` - Store chat messages between users and admins
      - `id` (uuid, primary key)
  ...
  3. Security
    ...
    - Add policies for users to view and send their own messages
    - Add policies for admins to view all messages and respond to users
*/

-- Create sender enum type
