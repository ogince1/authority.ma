-- Script pour appliquer la migration de la table blog_posts
...
DROP POLICY IF EXISTS "Les utilisateurs peuvent voir les articles publiés" ON public.blog_posts;
DROP POLICY IF EXISTS "Les auteurs peuvent voir leurs propres articles" ON public.blog_posts;
DROP POLICY IF EXISTS "Les administrateurs peuvent voir tous les articles" ON public.blog_posts;
DROP POLICY IF EXISTS "Les auteurs peuvent créer des articles" ON public.blog_posts;
DROP POLICY IF EXISTS "Les auteurs peuvent modifier leurs propres articles" ON public.blog_posts;
DROP POLICY IF EXISTS "Les administrateurs peuvent modifier tous les articles" ON public.blog_posts;
DROP POLICY IF EXISTS "Les auteurs peuvent supprimer leurs propres articles" ON public.blog_posts;
DROP POLICY IF EXISTS "Les administrateurs peuvent supprimer tous les articles" ON public.blog_posts;
