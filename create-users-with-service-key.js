...
if (!supabaseUrl || !supabaseServiceKey) {
  ...
  console.log('VITE_SUPABASE_ANON_KEY:', process.env.VITE_SUPABASE_ANON_KEY ? 'présente' : 'manquante');
  process.exit(1);
}

const supabase = createClient(supabaseUrl, supabaseServiceKey);

async function createUsersWithServiceKey() {
  try {
    console.log('=== Création d\'utilisateurs avec la clé de service ===\n');
