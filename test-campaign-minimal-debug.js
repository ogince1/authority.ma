...
async function testCampaignMinimalDebug() {
  console.log('🚀 Test minimal de débogage\n');
  ...
  try {
    ...
    // 4. Test avec des valeurs très courtes et champs minimaux
    console.log('🧪 Test avec des valeurs très courtes et champs minimaux...');
