...
console.log('🧪 TEST: Confirmation corrigée avec balance_before et balance_after\n');

async function testFixedConfirmation() {
  try {
    ...
    const { data: purchaseRequest, error: requestError } = await supabase
      ...
      .insert({
        ...
        target_url: 'https://test-fixed-confirmation.com',
        anchor_text: 'Test confirmation corrigée',
        proposed_price: 50,
        proposed_duration: 1,
        status: 'pending',
        message: 'Test de la confirmation corrigée avec balance_before et balance_after'
      })
      .select()
      .single();
    ...
    const { error: acceptError } = await supabase
      ...
      .update({
        ...
        placed_url: 'https://test-placement-fixed-confirmation.com',
    ...
    // TEST: Simuler la fonction confirmLinkPlacement corrigée
    console.log('\n🔍 TEST: Simulation de confirmLinkPlacement corrigée...');
    ...
    // Créer les transactions de crédit AVEC balance_before et balance_after
    console.log(`💳 Création des transactions de crédit avec balance_before et balance_after...`);
      ...
      .insert([
        {
          ...
          type: 'purchase',
          amount: purchaseRequest.proposed_price,
          description: 'Achat de lien (test corrigé)',
          currency: 'MAD',
          status: 'completed',
        ...
        },
        {
          ...
          description: 'Vente de lien (test corrigé)',
          currency: 'MAD',
          status: 'completed',
    ...
    console.log(`\n⏳ Attente de 3 secondes pour que les triggers se déclenchent...`);
