// Test du flux complet campagne → demande d'achat
...
async function testCampaignFlow() {
  console.log('🚀 Test du flux complet campagne → demande d\'achat\n');
  ...
  try {
    ...
    const { data: purchaseRequest, error: requestError } = await supabaseAdmin
      ...
      .insert([{
        ...
        anchor_text: 'test campagne',
        message: `Demande d'achat depuis la campagne ${campaign.name}`,
        proposed_price: 350,
