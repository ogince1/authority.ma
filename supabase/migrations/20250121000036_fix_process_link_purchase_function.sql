-- Fix process_link_purchase function to handle placed_at and placed_url correctly
-- Date: 2025-01-21

-- Recréer la fonction process_link_purchase avec la gestion correcte des colonnes
...
BEGIN
  ...
  -- Mettre à jour le statut de la demande (sans toucher à placed_at et placed_url)
