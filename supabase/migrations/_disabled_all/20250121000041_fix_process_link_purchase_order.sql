-- Fix process_link_purchase function to handle operations in correct order
-- Date: 2025-01-21

-- Recréer la fonction process_link_purchase avec l'ordre correct des opérations
...
BEGIN
  ...
  -- Créer les transactions de crédit (maintenant que la transaction existe)
